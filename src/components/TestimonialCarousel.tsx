...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    content: "We moved into a new flat and, after three exhausting months of trying (and failing) to renovate just one room, Will came along and sorted everything in a matter of days. He was super friendly, efficient and great value for money (especially considering the quality of his work!). Absolute lifesaver—wish we'd called him sooner!",
    rating: 5,
    date: "9 months ago",
  },
  {
    ...
    name: "Nicola Sweeney",
    reviewCount: "5 reviews",
    content: "I was lucky enough to find this company through a local Facebook site, I couldn't recommend them enough, especially Will, he has gone above and beyond for a full refurbishment of the flat. Always kept in contact and liased to make sure our needs where met. Would recommend to anyone perfect finish to a high standard 10/10",
    rating: 5,
    date: "7 months ago",
  },
  {
    ...
    content: "Will saved us from a DIY disaster after our failed mist coat! He stripped back our badly painted walls, repainted a room and bathroom, and removed wallpaper in the living room, leaving it ready for plastering. Great work—professional, efficient, and reliable. Will 100% be using him again!",
    rating: 5,
    date: "9 months ago",
    isLocalGuide: true,
    photos: "148 photos",
  },
  {
    ...
    name: "Chris Dodd",
    reviewCount: "5 reviews",
    content: "Gave out window frames at our shop a new lease on life! Very professional and efficient service",
    rating: 5,
    date: "a month ago",
    photos: "5 photos",
  },
